...
$(document).ready(() => {
  const links = [
    {
    name: 'gg/media',
    link: 'https://discord.gg/media'
  },
    {
	  name: 'ig',
	  link: 'https://instagram.com/69.nev'
	},
    {
      name: 'tiktok',
...
writeLine(["> Granting access to <span style='font-size: 14px; color: #ff91a4;'>[d4rk.cf]</span>....", `> Access granted! <span style='font-size: 14px; color: #ff91a4;'>[completed]</span>`], 45, () => {
